 ...
 *
 */
#ifndef LLFRAME_TENSOR_TENSOR_DEFINE_HPP
#define LLFRAME_TENSOR_TENSOR_DEFINE_HPP
...
template <template <size_t, class, class> class _Ty, size_t _Arg1, class _Arg2,
          class _Arg3>
struct _Is_Tensor<_Ty<_Arg1, _Arg2, _Arg3>>
    : std::is_base_of<Tensor<_Arg1, _Arg2, _Arg3>, _Ty<_Arg1, _Arg2, _Arg3>> {};
...
#endif // LLFRAME_TENSOR_TENSOR_DEFINE_HPP